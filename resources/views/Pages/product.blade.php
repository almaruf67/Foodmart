                                ...
                                <div class="col-md-12 item-detail-wrapper" id="style-3">
                                    ...
                                    <fieldset class="mb-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input class="size-version" type="radio" id="vanilla" name="flavor"
                                                value="vanilla">
                                            <label class="size-version-text" for="vanilla">Small</label>
                                        </div>

                                        <div class="d-flex align-items-center">
                                            <input class="size-version" type="radio" id="chocolate" name="flavor"
                                                value="chocolate">
                                            <label class="size-version-text" for="chocolate">Madium</label>
                                        </div>

                                        <div class="d-flex align-items-center">
                                            <input class="size-version" type="radio" id="strawberry" name="flavor"
                                                value="strawberry">
                                            <label class="size-version-text" for="strawberry">Large</label>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="row mt-3 border-bottom">
                                <div class="col-md-6 item-detail-wrapper" id="style-3">
                                    <div class="item-variation-list">
                                        <h5 class="dark_color">Add-ons</h5>
                                        <div class="pl-0 form-check pb-1">
                                            <label class="checkbox-wrap mb-0">Extra
                                                Beef
                                                Patty
                                                : <span class="text-muted">10.00$</span>
                                                <input type="checkbox" checked>
                                                <span class="checkmark  checkbox-primary"></span>
                                            </label>
                                        </div>
                                        ...
                                        <label class="checkbox-wrap mb-0">Extra
                                            ...
                                            <input class="checkbox-primary" type="checkbox" checked>
                                            <span class="checkmark checkbox-primary"></span>
                                        </label>
                                    </div><br>
                                </div>
                ...
                <div class="tf__menu_description_area mt_100 xs_mt_70">
                    <ul class="nav nav-pills border-bottom mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="active btn btnTheme btnShop fwEbold text-white py-md-3 px-md-4 py-3 px-3 mr-2"
